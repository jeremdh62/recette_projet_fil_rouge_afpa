...
import fr.afpa.recette.domain.UserInfo;
import fr.afpa.recette.repository.UserInfoRepository;
...
/**
 * REST controller for managing {@link fr.afpa.recette.domain.UserInfo}.
 */
@RestController
@RequestMapping("/api")
@Transactional

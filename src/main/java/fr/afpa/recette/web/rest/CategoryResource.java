...
import fr.afpa.recette.domain.Category;
import fr.afpa.recette.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link fr.afpa.recette.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional

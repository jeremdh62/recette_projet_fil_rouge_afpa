...
export const QuantityDeleteDialog = (props: IQuantityDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="afparecetteApp.quantity.delete.question">
        <Translate contentKey="afparecetteApp.quantity.delete.question" interpolate={{ id: quantityEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-quantity" color="danger" onClick={confirmDelete}>

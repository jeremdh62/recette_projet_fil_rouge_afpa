...
export const CategoryUpdate = (props: ICategoryUpdateProps) => {
  ...
  const { categoryEntity, recipes, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="afparecetteApp.category.home.createOrEditLabel">
            <Translate contentKey="afparecetteApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">

...
export const RecipeDeleteDialog = (props: IRecipeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="afparecetteApp.recipe.delete.question">
        <Translate contentKey="afparecetteApp.recipe.delete.question" interpolate={{ id: recipeEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-recipe" color="danger" onClick={confirmDelete}>

...
export class CategoryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('afparecetteApp.category.delete.question'));
...
export default class CategoryComponentsPage {
  ...
  async deleteCategory() {
    ...
    expect(await categoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/afparecetteApp.category.delete.question/);
